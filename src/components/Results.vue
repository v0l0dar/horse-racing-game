...
<template>
  <div v-if="results.length === 0" class="p-8 text-center text-gray-400 text-sm">Waiting for results...</div>
  ...
  <div v-else class="p-3 space-y-4">
    ...
    >
      ...
      <div class="px-3 py-2 bg-yellow-50/50 flex items-center gap-2 border-b border-yellow-100">
